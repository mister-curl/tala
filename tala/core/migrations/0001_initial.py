# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-09-03 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ipmi_ip_address', models.GenericIPAddressField(blank=True, null=True, protocol='IPv4')),
                ('ipmi_mac_address', models.CharField(blank=True, max_length=200)),
                ('ipmi_user_name', models.CharField(blank=True, max_length=200)),
                ('ipmi_password', models.CharField(blank=True, max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='OS',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(blank=True, max_length=200)),
                ('status', models.CharField(blank=True, max_length=200)),
                ('host_server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Node')),
            ],
        ),
    ]
